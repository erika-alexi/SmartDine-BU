...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen w-full">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-[#F57C00] to-[#FF9800] text-white py-20 w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl font-bold mb-4">SmartDine BU</h1>
            <p className="text-xl mb-2">Bicol University Polangui - Canteen Ordering System</p>
            <p className="text-lg opacity-90 mb-8">Order delicious Filipino food from our school canteen!</p>
            <button
              onClick={() => isAuthenticated ? navigate('/menu') : navigate('/login')}
              className="bg-white text-[#F57C00] px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 inline-flex items-center gap-2"
            >
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Today's Specials</h2>
